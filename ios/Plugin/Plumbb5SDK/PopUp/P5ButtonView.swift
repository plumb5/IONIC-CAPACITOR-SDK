...
class P5ButtonView: UIView {
    ...
    @objc func drawButton() {
        ...
        Utility.setAutolayout(toView: btn, inView: self, attributes: "0,0,0,0", fieldPosition: FieldPosition.None, topView: UIView(), topViewAttibutes: "nil", width: 0.0, alignment: "nil")
