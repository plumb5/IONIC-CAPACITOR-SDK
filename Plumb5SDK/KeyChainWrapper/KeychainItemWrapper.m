...
static const UInt8 kKeychainItemIdentifier[]    = "com.plumb5sdk.KeychainUI\0";
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        if (keychainErr == noErr) {
            ...
            self.keychainData = [self secItemFormatToDictionary:(NSMutableDictionary *)CFBridgingRelease(outDictionary)];
...
- (NSMutableDictionary *)secItemFormatToDictionary:(NSDictionary *)dictionaryToConvert
{
    ...
    if (keychainError == noErr)
    {
        ...
        NSString *password = [[NSString alloc] initWithBytes:[(NSData *)CFBridgingRelease(passwordData) bytes]
...
- (void)writeToKeychain {
                            ...
                            (CFTypeRef *)&attributes) == noErr)
    {
        ...
        updateItem = [NSMutableDictionary dictionaryWithDictionary:(NSDictionary *)CFBridgingRelease(attributes)];
