...
//        let Align = model.value(forKey: Constants.key_Align) as! String
        ...
        for index in 0...fields.count-1{
            ...
            Utility.setAutolayout(toView: btn, inView: self, attributes: Padding, fieldPosition: fieldPosition,topView: topView!,topViewAttibutes: nil, width:  CGFloat((Width as NSString).doubleValue)/CGFloat(fields.count), alignment: "");
            btn.setTitleColor(UIColor.init(hexString: Color), for: .normal)
        }
    }
