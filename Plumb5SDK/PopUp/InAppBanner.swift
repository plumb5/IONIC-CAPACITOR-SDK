...
class InAppBanner: UIView, UITextFieldDelegate {
    ...
    func drawBackgroung(display : NSDictionary){
        ...
        formView.backgroundColor = UIColor.init(hexString: BgColor)
        ...
        Utility.setAutolayout(toView: viewContainer, inView: formView, attributes: Padding, fieldPosition: .None, topView: UIView(), topViewAttibutes: nil, width: 0, alignment: nil)
    ...
    func drawTVWithParams(params : NSDictionary, fieldPosition:FieldPosition, topView:UIView, topViewParams : NSDictionary?, isIndependentField: Bool, inview: UIView, horizontalGroupCount:NSInteger){
        ...
        lable.textColor = UIColor.init(hexString: Color)
        ...
        Utility.setAutolayout(toView: lable, inView: labelContainer, attributes: convertPostions(position: Padding),fieldPosition: .None, topView: topView,topViewAttibutes: nil, width: CGFloat((Width as NSString).doubleValue), alignment: nil);
        let BgColor = params.value(forKey: Constants.key_BgColor) as! String
        labelContainer.backgroundColor = UIColor.init(hexString: BgColor)
        if isIndependentField {
    ...
    func drawCbWithParams(params : NSDictionary, fieldPosition:FieldPosition, topView:UIView, topViewParams : NSDictionary?, isIndependentField: Bool, inview: UIView, horizontalGroupCount:NSInteger){
        ...
        let Color = params.value(forKey: Constants.key_Color) as! String
        let Orientation = params.value(forKey: Constants.key_Orientation) as! String
        checkBox.setTitleColor(UIColor.init(hexString: Color), for: .normal)
        checkBox.setTitleColor(UIColor.init(hexString: Color), for: .selected)
        ...
        Utility.setAutolayout(toView: checkBox, inView: container, attributes: Padding,fieldPosition: .None, topView: topView,topViewAttibutes: nil, width:0.0 , alignment: nil);
    ...
    func drawSpinner(params : NSDictionary, fieldPosition:FieldPosition, topView:UIView, topViewParams : NSDictionary?, isIndependentField: Bool, inview: UIView, horizontalGroupCount: NSInteger) {
        ...
        Utility.setAutolayout(toView: btn, inView: container, attributes: Padding, fieldPosition: .None,topView: topView,topViewAttibutes: nil, width:0.0,alignment: nil);
    ...
    func drawImageWithParams(params : NSDictionary, fieldPosition:FieldPosition, topView:UIView, topViewParams : NSDictionary?, isIndependentField: Bool, inview: UIView, horizontalGroupCount:NSInteger){
        ...
        Utility.setAutolayout(toView: imageView, inView: container, attributes: Padding, fieldPosition: .None,topView: topView,topViewAttibutes: nil, width:0.0,alignment: nil);
        if isIndependentField {
            self.uiIndependsFields.append(container)
        }else{
            self.uiFields.append(container)
