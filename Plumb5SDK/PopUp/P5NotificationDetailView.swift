...
class P5NotificationDetailView: UIView {
    ...
    func drawNotificationBanner(){
        ...
        //        }
        Utility.setAutolayout(toView: formView, inView: mainViewContainer, attributes: "0,0,0,0", fieldPosition: .VerticallyFirst, topView: UIView(), topViewAttibutes: nil, width: 0, alignment: nil)
        ...
        Utility.setAutolayout(toView: extraButtonView, inView: mainViewContainer, attributes: "0,5,0,0", fieldPosition: .VerticallyLast, topView: viewContainer, topViewAttibutes: nil, width: 0, alignment: nil)
    ...
    func drawImageWithParams(imageUrl : String, inView:UIView){
        ...
        Utility.setAutolayout(toView: imageView, inView: inView, attributes: Padding, fieldPosition: .None,topView: UIView(),topViewAttibutes: nil, width:0.0,alignment: nil);
        activityIndicator.startAnimating()
