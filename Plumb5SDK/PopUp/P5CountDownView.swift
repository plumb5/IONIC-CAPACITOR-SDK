...
class P5CountDownView: UIView {
    ...
    @objc func drawCountDownView(){
        ...
        Utility.setAutolayout(toView: lable, inView: self, attributes: Padding,fieldPosition: .None, topView: UIView(),topViewAttibutes: nil, width: CGFloat((Width as NSString).doubleValue), alignment: nil);
        updateCountDownTime()
