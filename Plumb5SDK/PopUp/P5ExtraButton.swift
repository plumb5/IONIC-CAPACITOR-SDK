...
class P5ExtraButton: UIView {
    ...
    @objc func refreshUI(){
        ...
        if useIcon == "1"{
            let imgClose = UIImage.init(named: btnIconId!, in: frameWorkBundle, compatibleWith: nil);
        ...
        Utility.setAutolayout(toView: btn, inView: self, attributes: "0,0,0,0", fieldPosition:.None, topView: UIView(), topViewAttibutes: nil, width: 0, alignment: nil)
