...
import Foundation
public protocol P5BannerDelegate : class{
    func bannerLoaded()
    func bannerRemoved()
}
public class P5BannerView : UIView{
    ...
    @objc func refreshUI(){
        ...
        Utility.setAutolayout(toView: bgImageView, inView: self, attributes: "0,0,0,0", fieldPosition: .None, topView: UIView(), topViewAttibutes: "0,0,0,0", width: 0.0, alignment: nil)
