...
class P5TextFieldView: P5BaseFromView,UITextFieldDelegate {
    ...
    @objc func drawTextField(){
        ...
        textField.textColor = UIColor.init(hexString: Color)
        ...
        Utility.setAutolayout(toView: textField, inView: self, attributes: Padding,fieldPosition: .None, topView: UIView(),topViewAttibutes: nil, width:0.0, alignment: nil);
